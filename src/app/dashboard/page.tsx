...
import { BookOpen, Calendar, Clock, Database, Play, Trophy, Users } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8 pt-28!">
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {bootcamps.map((bootcamp: any) => (
            <Card key={bootcamp.id} className="hover:shadow-xl transition-shadow">
              <CardHeader>
      ...
      <div className="mt-12 p-4 bg-purple-50 border border-purple-200 rounded-lg">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-medium text-purple-800">Información de Desarrollo</span>
        </div>
